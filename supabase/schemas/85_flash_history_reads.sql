...
-- The existing S03 result RPC remains owner-only and completed-only. This
-- separate projection adds abandoned attempts and an explicit peer-review
-- policy for the historical room surface.
