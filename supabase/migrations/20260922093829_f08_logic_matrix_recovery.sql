...
begin
  ...
  if found then
    ...
    if found then
      ...
      elsif question.type in ('mini-wordle', 'logic-code', 'logic-matrix', 'progressive-clues', 'matching', 'progressive-image', 'queens', 'word-search') and instant < unit.deadline_at then
