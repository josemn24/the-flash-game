...
-- S15 competitive format slice 2/3: admit published Escape questions.
...
begin
  if expected_type not in ('true-false', 'ordering', 'classification', 'logic-matrix', 'zip', 'escape') then
    return false;
  end if;
