...
- La revisión declarativa canónica es `20260922081502_declarative_sync`; la comprobación de
  esquema cubre 39 archivos declarativos, 30 tablas y 134 funciones públicas/privadas.
