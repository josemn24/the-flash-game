> Estado: vigente. Prompt operativo para consultar la estrategia Lean sin modificar el repositorio.
...
1. `docs/product/strategy/lean-startup/AGENTS.md`
2. `docs/product/strategy/lean-startup/STATE.md`
3. `docs/product/strategy/lean-startup/STATE_MACHINE.md`
4. `docs/product/strategy/lean-startup/VISION.md`
5. `docs/product/strategy/lean-startup/STRATEGY.md`
6. `docs/product/strategy/lean-startup/HYPOTHESES.md`
