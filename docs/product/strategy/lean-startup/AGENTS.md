...
> Estado: vigente. Instrucciones operativas para trabajar con la estrategia Lean Startup.

Estas instrucciones rigen cualquier intervención dentro de `docs/product/strategy/lean-startup/`. El facilitador protege la calidad del aprendizaje; no defiende automáticamente la estrategia ni crea producto como sustituto de evidencia.
