...
- La dirección de producto descrita es una sala privada de amigos con desafíos periódicos asíncronos y ranking de temporada. Fuente: `../../../archive/salas-y-temporadas.md`.
- La PoC pretendía explorar si el desafío individual era divertido y fluido. Fuente: `../../../archive/the-flash-poc.md`.
