> Estado: propuesta. Roadmap activo; no describe funcionalidades implementadas ni alcance comprometido.
...
8. **Narrativo competitivo**, por añadir contexto compartido sin perder ranking individual. La primera implementación es «El que caminaba hacia las montañas», documentada en [`../../content/challenges/desafio-04-el-que-caminaba-hacia-las-montanas.md`](../../content/challenges/desafio-04-el-que-caminaba-hacia-las-montanas.md).
