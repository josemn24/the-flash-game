...
- Siete formatos de pregunta con reglas y puntuación propias.
...
| `/formatos`         | Catálogo de los siete formatos disponibles.                   |
...
Los tests actuales cubren la integridad del catálogo de formatos y las reglas de evaluación y puntuación. El build genera estáticamente la portada, la biblioteca, las dos etapas y las siete fichas de formato.
