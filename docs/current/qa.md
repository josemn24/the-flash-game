...
- `npm test`: 88 archivos de test y 568 tests superados.
...
- `npm run supabase:schema:test`: correcto; inventario, provisioning, S02–S08, S10, S11, portal
  privado, comandos editoriales y pruebas concurrentes con conexiones PostgreSQL independientes.
...
- La validación E2E de S01–S11 usa escenarios locales reproducibles; no se ha verificado un proyecto
