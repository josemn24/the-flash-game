...
- [ ] `npm run format:check` — avisos en 59 archivos, fuera del alcance de esta migración documental
- [x] `npm run dictionary:check`
- [x] `npm run lint`
- [ ] `npm run stylelint` — selector duplicado en `app/flash-pop-concepts/FlashPopConcepts.module.css`
- [x] `npm test`
- [x] `npm run build`
