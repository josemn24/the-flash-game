...
> **Estado: histórico.** Flash Pop ya está integrado en la aplicación. Estos documentos conservan
> el proceso y las decisiones del rediseño; el estado vigente está en [`../../current/status.md`](../../current/status.md).
