...
> **Estado: histórico.** Este plan ya fue superado por el store mock normalizado y la capa de
> consultas actual. Consulta [`../current/domain/README.md`](../current/domain/README.md) y
> [`../current/domain/data-access.md`](../current/domain/data-access.md) para la referencia vigente.

> **Estado:** documento histórico de la evolución del prototipo. Las reglas normativas para el
> modelo futuro están en [`../current/domain/README.md`](../current/domain/README.md) y
> [`../decisions/decisions.md`](../decisions/decisions.md). Si existe una contradicción, prevalece la
> documentación de dominio.
>
> El estado técnico vigente está en [`../current/domain/mock-data.md`](../current/domain/mock-data.md) y
> [`../current/domain/data-access.md`](../current/domain/data-access.md): las fases de fixtures canónicos/store
