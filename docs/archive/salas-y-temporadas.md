...
> **Estado: histórico.** Este documento conserva el contexto inicial del loop social. Las reglas
> vigentes están en [`../decisions/decisions.md`](../decisions/decisions.md) y el estado técnico en
...
El cuarto desafío de la temporada mock es la misión narrativa **El que caminaba hacia las montañas**. Su relato, sus ocho pruebas y sus límites editoriales están documentados en [`../content/challenges/desafio-04-el-que-caminaba-hacia-las-montanas.md`](../content/challenges/desafio-04-el-que-caminaba-hacia-las-montanas.md).
