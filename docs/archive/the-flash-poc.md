> **Estado: histórico.** Este documento describe una etapa anterior de la PoC. Para el estado vigente
> consulta [`../current/status.md`](../current/status.md).

# The Flash: estado anterior de la PoC
