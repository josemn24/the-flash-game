...
describe("question format catalog", () => {
  it("contains exactly thirteen formats with unique slugs", () => {
    expect(questionFormats).toHaveLength(13);
    expect(new Set(questionFormats.map((format) => format.slug)).size).toBe(13);
