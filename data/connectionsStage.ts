...
export const connectionsStage: Stage = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: "multiple-choice",
      category: "Literatura",
      question: "¿Qué obra escribió George Orwell?",
      options: ["1984", "Un mundo feliz", "Fahrenheit 451", "La metamorfosis"],
      correctAnswer: "1984",
      timeLimit: 10,
      points: 110,
      explanation: "George Orwell publicó 1984 en 1949. Es una de las novelas distópicas más influyentes.",
    },
    {
      id: "byte-bits",
      type: "true-false",
