...
export const questionsById = {
  ...
  "mountains-progressive-image": {
    id: "mountains-progressive-image",
    type: "progressive-image",
    category: "Observación de campo",
    tags: {
      domains: ["geography", "natural_sciences"],
      topics: ["orientation"],
      cognitiveSkills: ["pattern_recognition", "critical_thinking"],
      formatSkills: ["interpretation"],
      lifeSkills: ["environmental_awareness"],
    },
    question:
      "La colonia avanza hacia el agua abierta. ¿Hacia qué referencia del paisaje se orienta el pingüino que abandona la formación?",
    surface: {
      src: "/visuals/p17/colony-panorama.jpg",
      alt: "Panorama antártico que se revela progresivamente, con una colonia y un pingüino separado de la formación",
      width: 1920,
      height: 1080,
      fit: "cover",
      position: "50% 52%",
    ...
    solutionAlt:
      "La colonia avanza hacia el mar situado a la derecha, mientras P-17 se orienta hacia la cordillera situada a la izquierda",
    revealDuration: 12,
    correctAnswer: "las montañas",
    acceptedAnswers: [
      "montañas",
      "las montañas",
      "cordillera",
    ...
    answerLabel: "Escribe la referencia observable",
    answerPlaceholder: "Montañas, mar, colonia…",
    timeLimit: 24,
    points: 100,
    explanation:
      "P-17 gira hacia la línea de montañas, en dirección al interior. La imagen permite registrar una dirección, no una intención.",
  },
  "trajectory-deviation-heat-map": {
    id: "trajectory-deviation-heat-map",
    type: "heat-map",
    category: "Cartografía de observación",
    tags: {
      domains: ["geography", "mathematics"],
      topics: ["orientation"],
      cognitiveSkills: ["pattern_recognition", "logical_reasoning"],
      formatSkills: ["interpretation"],
      lifeSkills: ["environmental_awareness"],
    },
    question:
      "Señala el punto donde la trayectoria de P-17 abandona el corredor habitual hacia el mar.",
    surface: {
      src: "/visuals/p17/trajectory-map.svg",
      alt: "Mapa de sectores con una concentración de recorridos hacia el mar y una trayectoria que se separa hacia el interior",
      width: 1600,
      height: 1000,
      fit: "contain",
    },
    target: { x: 0.42, y: 0.48 },
    targetLabel: "Inicio del desvío de P-17",
    fullCreditRadius: 0.06,
    toleranceRadius: 0.16,
    timeLimit: 25,
    points: 100,
    explanation:
      "La mayoría de recorridos continúa hacia el mar. P-17 abandona esa concentración en el punto marcado y mantiene una línea hacia el interior.",
  },
  "observation-vs-interpretation": {
    id: "observation-vs-interpretation",
    type: "classification",
    category: "Método de observación",
    tags: {
      domains: ["natural_sciences"],
      topics: ["biology_taxonomy"],
    ...
    question:
      "Clasifica las notas. Una observación describe algo registrado; una interpretación atribuye una causa, intención o estado que no se ha medido.",
    categories: ["Hecho observado", "Interpretación no demostrada"],
    items: [
      { label: "P-17 gira hacia el interior", correctCategory: "Hecho observado" },
      { label: "Se separa de la dirección de la colonia", correctCategory: "Hecho observado" },
      {
        label: "No regresa al grupo durante el periodo observado",
        correctCategory: "Hecho observado",
      },
      {
        label: "Mantiene el rumbo durante 42 minutos de grabación",
        correctCategory: "Hecho observado",
      },
      { label: "Está enfermo", correctCategory: "Interpretación no demostrada" },
      { label: "Sigue un sonido", correctCategory: "Interpretación no demostrada" },
      { label: "Ha perdido el rumbo", correctCategory: "Interpretación no demostrada" },
      { label: "Ha decidido morir", correctCategory: "Interpretación no demostrada" },
    ],
    timeLimit: 35,
    points: 100,
    explanation:
      "La cámara registra posiciones, direcciones y tiempos. No registra enfermedad, intención, percepción ni conocimiento.",
  },
  "clear-camp-escape": {
  ...
  "p17-evidence-matrix": {
    ...
    question:
      "La cámara de Nadir registra una muesca blanca izquierda, entrada desde el nordeste y una ventana de viaje de 50 horas. ¿Qué identificación es compatible con los tres datos?",
    options: ["P-17", "P-23", "P-41", "No hay ninguna identificación compatible"],
    correctAnswer: "P-17",
    media: {
      type: "image",
      src: "/visuals/p17/evidence-matrix.svg",
      alt: "Matriz comparativa de P-17, P-23 y P-41 con marca de pecho, rumbo y ventana temporal",
      fit: "contain",
    },
    timeLimit: 35,
    points: 100,
    explanation:
      "P-17 es la única fila que coincide en marca, rumbo y tiempo. El resultado identifica de forma compatible al individuo observado; no explica su conducta.",
  },
  "p17-route-zip": {
    id: "p17-route-zip",
    type: "zip",
  ...
  "p17-final-record": {
    ...
    tags: {
      ...
      topics: ["orientation"],
      cognitiveSkills: ["scientific_reasoning", "critical_thinking"],
      formatSkills: ["deduction", "interpretation"],
      lifeSkills: ["environmental_awareness"],
    },
    question:
      "Localiza la primera frase que afirma más de lo que muestran los registros y sustitúyela por una conclusión válida.",
    steps: [
      { id: "colony", text: "La colonia avanzó hacia el agua abierta" },
      { id: "separation", text: "P-17 se separó y continuó hacia el interior" },
      {
        id: "nadir",
        text: "La observación de Nadir fue compatible con P-17 por marca, rumbo y tiempo",
      },
      { id: "cause", text: "P-17 estaba perdido y había decidido alejarse de la colonia" },
      { id: "mountains", text: "El último registro lo mostró avanzando hacia las montañas" },
    ],
    firstErrorStepId: "cause",
    correction: {
      options: [
        "La causa de la trayectoria no pudo determinarse",
        "P-17 seguía un sonido procedente de las montañas",
        "P-17 buscaba una colonia nueva",
        "P-17 había dejado de reconocer el océano",
      ],
      correctAnswer: "La causa de la trayectoria no pudo determinarse",
    },
    instruction: "Señala la primera frase que entra en la mente de P-17 en lugar de describirlo.",
    correctionLabel: "Sustituye la inferencia por el límite de la evidencia",
    correctionRequired: true,
    submitLabel: "Cerrar el registro",
    timeLimit: 40,
    points: 100,
    explanation:
      "Todos los registros describen posiciones, dirección, tiempo e identidad compatible. Ninguno permite afirmar que P-17 estuviera perdido ni que hubiera decidido alejarse.",
  },
