...
export const questionsById = {
  ...
  "alphabet-animals-e": {
    ...
    question: "Mayor mamífero terrestre, reconocible por su trompa.",
    correctAnswer: "elefante",
    acceptedAnswers: ["elefante", "elefantes"],
    timeLimit: 120,
    points: 100,
    explanation:
      "La respuesta es «elefante»: es el mayor mamífero terrestre y su trompa es su rasgo más reconocible.",
  },
  "alphabet-animals-f": {
  ...
  "alphabet-animals-i": {
    ...
    question: "Lagarto tropical herbívoro con una cresta de espinas sobre el lomo.",
    correctAnswer: "iguana",
    acceptedAnswers: ["iguana", "iguanas"],
    timeLimit: 120,
    points: 100,
    explanation:
      "La respuesta es «iguana»: este lagarto tropical presenta una característica cresta dorsal.",
  },
  "alphabet-animals-j": {
  ...
  "alphabet-animals-m": {
    ...
    question: "Único mamífero capaz de realizar vuelo sostenido.",
    correctAnswer: "murciélago",
    acceptedAnswers: ["murciélago", "murciélagos"],
    timeLimit: 120,
    points: 100,
    explanation:
      "La respuesta es «murciélago»: es el único mamífero capaz de mantener un vuelo activo.",
  },
  "alphabet-animals-o": {
    ...
    question: "Mamífero australiano que pone huevos y tiene pico parecido al de un pato.",
    correctAnswer: "ornitorrinco",
    acceptedAnswers: ["ornitorrinco", "ornitorrincos"],
    timeLimit: 120,
    points: 100,
    explanation:
      "La respuesta es «ornitorrinco»: este mamífero australiano pone huevos y posee un pico aplanado.",
  },
  "alphabet-animals-p": {
  ...
  "alphabet-animals-r": {
    ...
    question: "Gran herbívoro de piel gruesa con uno o dos cuernos sobre el hocico.",
    correctAnswer: "rinoceronte",
    acceptedAnswers: ["rinoceronte", "rinocerontes"],
    timeLimit: 120,
    points: 100,
    explanation:
      "La respuesta es «rinoceronte»: es un gran herbívoro con uno o dos cuernos sobre el hocico.",
  },
