...
export const questionsById = {
  ...
  "pyramid-algebra-error": {
    id: "pyramid-algebra-error",
    ...
    question: "Localiza el primer error al resolver 3(x − 2) = 2x + 5.",
    steps: [
      { id: "original", text: "Partimos de 3(x − 2) = 2x + 5." },
      { id: "distribute", text: "Distribuimos: 3x − 2 = 2x + 5." },
      { id: "isolate", text: "Restamos 2x: x − 2 = 5." },
      { id: "result", text: "Sumamos 2: x = 7." },
    ],
    firstErrorStepId: "distribute",
    correction: {
      options: ["3x − 6 = 2x + 5", "3x − 2 = 2x + 15", "3x − 5 = 2x + 2"],
      correctAnswer: "3x − 6 = 2x + 5",
    },
    correctionRequired: true,
    timeLimit: 35,
    points: 100,
    explanation:
      "El 3 multiplica a los dos términos del paréntesis: 3(x − 2) = 3x − 6. La ecuación correcta conduce a x = 11.",
  },
  "pyramid-secret-code": {
