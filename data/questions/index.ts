...
export const questionsById = {
  ...
  "clear-camp-escape": {
    ...
    referenceSolution: [
      { blockId: "case-c", from: 2, to: 0 },
      { blockId: "sled-b", from: 1, to: 3 },
      { blockId: "case-d", from: 2, to: 3 },
      { blockId: "crate-a", from: 0, to: 3 },
      { blockId: "tripod", from: 0, to: 3 },
      { blockId: "crate-a", from: 3, to: 0 },
      { blockId: "sled-b", from: 3, to: 0 },
      { blockId: "case-d", from: 3, to: 0 },
      { blockId: "case-c", from: 0, to: 3 },
      { blockId: "tripod", from: 3, to: 4 },
    ],
    optimalMoves: 10,
