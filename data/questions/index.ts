...
export const questionsById = {
  ...
  "spain-survival-capital": {
    id: "spain-survival-capital",
    type: "multiple-choice",
    category: "Geografía",
    tags: {
      domains: ["geography"],
    ...
    timeLimit: 9,
    points: 100,
    explanation: "Madrid es la capital de España y sede del Gobierno y de las Cortes Generales.",
  },
  ...
  "spain-survival-food-odd": {
    ...
    question: "¿Qué plato no se asocia de forma característica con España?",
    items: [
      { id: "paella", label: "Paella" },
      { id: "gazpacho", label: "Gazpacho" },
      { id: "tortilla", label: "Tortilla de patatas" },
    ...
    points: 100,
    explanation:
      "Paella, gazpacho y tortilla de patatas son platos muy asociados a España; el sushi pertenece a la cocina japonesa.",
  },
  ...
  "spain-survival-west-east-cities": {
    ...
    question: "Ordena estas ciudades españolas de oeste a este.",
    items: ["A Coruña", "Madrid", "Valencia", "Barcelona"],
    correctOrder: ["A Coruña", "Madrid", "Valencia", "Barcelona"],
    directionLabels: { start: "Más al oeste", end: "Más al este" },
    timeLimit: 16,
    points: 100,
    explanation:
      "A Coruña está en el noroeste, Madrid en el centro, Valencia en el este y Barcelona más al nordeste.",
  },
  ...
  "spain-survival-ramon-cajal": {
    ...
    question: "Santiago Ramón y Cajal recibió el Nobel por sus estudios sobre el sistema nervioso.",
    correctAnswer: true,
    timeLimit: 10,
    points: 100,
    explanation:
  ...
  "spain-survival-population-estimate": {
    id: "spain-survival-population-estimate",
    type: "estimation",
    category: "Sociedad",
    tags: {
      domains: ["geography", "society_politics_law"],
      topics: ["maps"],
      cognitiveSkills: ["quantitative_reasoning"],
      formatSkills: ["estimation"],
    },
    question: "Aproxima la población de España en millones de habitantes.",
    correctAnswer: 49,
    min: 35,
    max: 60,
    step: 1,
    ...
    points: 100,
    explanation:
      "España se sitúa alrededor de los 49 millones de habitantes en estimaciones recientes; la prueba premia la cercanía.",
  },
  ...
  "spain-survival-history-order": {
    ...
    question: "Ordena estos hechos de la historia de España del más antiguo al más reciente.",
    items: ["Llegada romana a Hispania", "1492", "Constitución de Cádiz", "Constitución de 1978"],
    correctOrder: [
      "Llegada romana a Hispania",
      "1492",
    ...
    points: 100,
    explanation:
      "Roma llega a Hispania en la Antigüedad; 1492 precede a la Constitución de Cádiz de 1812 y a la Constitución de 1978.",
  },
