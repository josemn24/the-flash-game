...
export const questionsById = {
  ...
  "sbr-gallop-faster-than-trot": {
    id: "sbr-gallop-faster-than-trot",
    type: "true-false",
    category: "Deporte",
    tags: {
    ...
    question: "El galope suele ser más rápido que el trote.",
    correctAnswer: true,
    timeLimit: 7,
    points: 100,
    explanation: "El galope es un aire más rápido que el trote y se usa en carreras y acelerones.",
  },
  "sbr-pony-express": {
    id: "sbr-pony-express",
    type: "multiple-choice",
