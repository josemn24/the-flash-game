...
export const challengeDefinitions = {
  ...
  "pyramid-logic-definition": {
    ...
    questionPoints: {
      ...
      "pyramid-growing-products": 12,
      "pyramid-constraint-order": 13,
      "pyramid-shape-direction-matrix": 14,
      "pyramid-connect-pairs-trap": 15,
      "pyramid-secret-code": 17,
      "pyramid-summit-queens": 19,
    },
  },
  "pyramid-abrahamic-definition": {
    ...
    questionPoints: {
      "abrahamic-matching-biblical-associations": 10,
      "abrahamic-progressive-abraham": 12,
      "abrahamic-order-torah-books": 13,
      "abrahamic-mini-wordle-josue": 14,
      "abrahamic-word-search-biblical-characters": 15,
      "abrahamic-classification-three-traditions": 17,
      "abrahamic-word-hashtag-references": 19,
    },
  },
